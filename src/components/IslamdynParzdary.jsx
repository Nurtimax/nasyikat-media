               ...
               <AccordionDetailsStyled>
                  <Typography component="div">
                     <ol>
                        ...
                        <ListItem>
                           Тагдырга ишенүү : жакшылык жана жамандык Аллахтан
                           экендигине ишенүү
                        </ListItem>
                        <ListItem>
               ...
               <AccordionDetailsStyled>
                  <Typography component="div">
                     <ol>
                        ...
                        <ListItem>
                           Баштын төрттөн бир бөлүгүнө масх тартуу
                        </ListItem>
            ...
            <StyledAccordion>
               ...
               <AccordionDetailsStyled>
                  <Typography component="div">
                     ...
                     <ol>
                        <ListItem>
                           Нажасаттан таза болуу: даарат алуу, гусул алуу, айыз
                           жана нифастан таза болуу
                        </ListItem>
                        <ListItem>Кийимдин таза болуусу</ListItem>
                        <ListItem>
                           Намаз окуй турган жайдын таза болуусу
                        </ListItem>
                        <ListItem>Аврат жерлердин жабык болуусу</ListItem>
                        <ListItem>Кыбылага жүз буруу</ListItem>
                        <ListItem>
                           Окула турган намаздын убактысынын кирүүсү
                        </ListItem>
