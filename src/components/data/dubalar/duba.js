...
const duaData = [
  ...
  },
  {
    ...
    transcription: 'Бисмиллаахи',
    kyrgyz: 'Аллахтын аты менен (баштайм). (Бухари)',
    images: imgexam,
  },
  {
    title: 'Башында унутуп калса, анда бул дуба окулат',
  ...
  {
    title: 'Конокко барганда окулуучу',
  ...
  },
  {
    ...
    transcription:
      'Алхамду лил-лаахил-лазии сакоонаа азбан фуроотан бирохматихииваламйажъалху милханужаажан бизунуубинаа.',
    kyrgyz:
  ...
  },
  {
    ...
    kyrgyz:
      'Оо, Аллахым! Мен Сенин атын менен гана елем (уктайм) жана тирилем (ойгоном). (Бухари)',
    images: imgexam,
  },
  {
    ...
    transcription:
      'Алхамду лилахил-лазии ахиаанаа баъда маа амаатанаа,ва илайхин-нушуур.',
    kyrgyz:
      'Бизге елум бергенден (уктаткандан) кийин кайра тирилткен (ойготкон) Аллах Таалага бардык мактоолор болсун жана биз Ага гана кайтып барабыз. (Бухари)',
    images: imgexam,
  },
  {
  ...
  },
  {
    ...
    transcription:
      'Алхамду лил-лаахил-лазии касаании Хаазаа розакониихи мин гойри хавлим-миннии ва лаа кувватин.',
    kyrgyz:
  ...
  },
  {
    ...
    transcription:
      'Бисмиллаахи таваккалту алаллоохи, лаа хавла валаа кувата иллаа биллаах',
    kyrgyz:
      'Мен Аллахтын аты менен уйден чыктым жана Ага гана тобокел кылдым. Кунеелерден сактанууга жана жакшы амал кылууга куч-кубат Аллахтан гана болот. (Тирмизи',
    images: imgexam,
  },
  {
  ...
  },
  {
    ...
    transcription:
      '"БИСМИЛЛААХИЛЛАЗИИ ЛАА ЯЗУРРУ МАЬА СМИХИИ ШАЙ-УН ФИЛ-АРЗИ ВА ЛАА ФИС-САМАА-И ВА ХУВА-ССАМИИЬУЛ ЬАЛИИМ"',
    kyrgyz:
