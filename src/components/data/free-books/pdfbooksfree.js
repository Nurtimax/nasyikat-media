...
const books = [
  {
    title: 'Зекет китеби',
    description: 'Намазды тургузгула жана зекетти ада кылгыла бул аят',
    image: logo,
    pdf: zeketpdf,
    avatar: logo,
    name: 'Author Name 1',
  ...
  },
  {
    ...
    description:
      'Ислам - мировая цивилизация, которая спасла не только Аравийский полуостров, но и все человечество от невежества и мрака.',
    author: 'Хайати Улькю',
    image: logo,
    pdf: historyislampdf,
    avatar: logo,
  ...
  },
  {
    ...
    description:
      'Исламские течения и группы предназначена для студентов-теологов, исламоведов и востоковедов.',
    author: 'Д.А. Шагавиев',
    image: logo,
    pdf: islamagymdar,
    avatar: logo,
