      ...
      <Container maxWidth="lg">
        <StyledBox>
          ...
          <StyledText variant="body1" component="div">
            ...
            менен болгон баарлашуусу. <br /> Анткени, намаздын ичинде бир канча
            ибаадаттар бар. Мында даарат, ниет, Аллахка сажда кылуу,
            <br />
            ...
            жакындайт, туура жолго багыт алат, ыйманын бекемдейт, жүрөгү, денеси
            тазарып, жан дүйнөсү тынчтык табат,Акыреттеги эң биринчи суракка
            даярданат. <br /> Намаз тууралуу хадисте төмөндөгүчө айтылат:
            <br />
