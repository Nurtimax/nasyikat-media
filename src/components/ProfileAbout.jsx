  ...
  return (
    ...
    >
      ...
      <Stack spacing={3} sx={{ p: 3 }}>
        ...
        <Typography variant="body2">
          Ассаламу алейкум мусулман бир туугандар Аллах тааланын динине элибизге
          жерибизге кызмат кылуу биз үчүн чоң сыймык биздин сайттан устаздардын
          баяндарын жана ошондой эле инстаграм блок кылып жаткан видеолорду көрө
          аласыздар. <br /> Админ <b>Nasyikat.media</b>
        </Typography>
      </Stack>
    </Card>
  );
