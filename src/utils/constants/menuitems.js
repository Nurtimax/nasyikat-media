...
const menuItems = [
  ...
  { text: 'Намаз убактысы', path: '/namaztimes', icon: <AccessTimeIcon /> },
  {
    text: 'Исламда 40 парз',
  ...
  { text: 'Кыска Дубалар', path: '/duba', icon: <BookIcon /> },
  { text: 'Куттуy Хадистер', path: '/hadis', icon: <BookIcon /> },
  { text: 'Онлайн Дүкөн', path: '/store', icon: <StoreIcon /> },
  { text: 'Ал Жардам', path: '/aljardam', icon: <VerifiedIcon /> },
  { text: 'Кыска Сүрөлөр', path: '/onsuro', icon: <BookIcon /> },
